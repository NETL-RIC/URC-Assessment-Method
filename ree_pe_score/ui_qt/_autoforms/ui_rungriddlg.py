...
class Ui_CreateGridDlg(object):
    def setupUi(self, CreateGridDlg):
        ...
        self.clipLayerCB = QtWidgets.QCheckBox(self.groupBox)
        self.clipLayerCB.setObjectName("clipLayerCB")
        self.gridLayout.addWidget(self.clipLayerCB, 2, 0, 1, 1)
        ...
        self.clipLayerButton = QtWidgets.QPushButton(self.groupBox)
        self.clipLayerButton.setEnabled(False)
        self.clipLayerButton.setObjectName("clipLayerButton")
        self.gridLayout.addWidget(self.clipLayerButton, 2, 2, 1, 1)
        ...
        self.clipLayerLbl = ElideLabel(self.groupBox)
        self.clipLayerLbl.setEnabled(False)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.clipLayerLbl.sizePolicy().hasHeightForWidth())
        self.clipLayerLbl.setSizePolicy(sizePolicy)
        font = QtGui.QFont()
        font.setItalic(True)
        self.clipLayerLbl.setFont(font)
        self.clipLayerLbl.setObjectName("clipLayerLbl")
        self.gridLayout.addWidget(self.clipLayerLbl, 2, 1, 1, 1)
    ...
    def retranslateUi(self, CreateGridDlg):
        ...
        self.clipLayerCB.setText(_translate("CreateGridDlg", "Clip Layer"))
        self.ldInputLbl.setText(_translate("CreateGridDlg", "None"))
        self.clipLayerButton.setText(_translate("CreateGridDlg", "Select..."))
        self.heightField.setText(_translate("CreateGridDlg", "1000"))
        self.clipLayerLbl.setText(_translate("CreateGridDlg", "None"))
