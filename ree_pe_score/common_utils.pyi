...
from typing import Callable,Dict,Sequence,Generator,Union,Set,Any,Optional,Tuple,List
import pandas as pd
import numpy as np
...
class RasterGroup(object):
    ...
    def generateHitMap(self)->np.ndarray: ...
...
def Rasterize(id:str,inDS:gdal.Dataset,xSize:int,ySize:int,geotrans:Tuple[float,float,float,float,float,float],
