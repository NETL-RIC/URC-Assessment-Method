...
class RasterGroup(object):
    ...
    def update(self,other:RasterGroup)->None: ...
    def clipWithRaster(self,clipRaster:gdal.Dataset,shrinkToFit:bool=...)->None: ...
    ...
    @property
    def emptyRasterNames(self)->List[str]: ...
...
def NormMultRasters(implicits:RasterGroup,explicits:RasterGroup,cache_dir:Optional[str]=...)->RasterGroup:
    ...

def NormLGRasters(inRasters:RasterGroup,cache_dir:Optional[str]=...)->RasterGroup:
    ...
